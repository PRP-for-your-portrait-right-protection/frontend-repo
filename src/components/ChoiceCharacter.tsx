...
// interface ChoiceCharacterProps {
//   object: any;
//   changeFuc: any;
// }

// function ChoiceCharacter({ object, changeFuc }: ChoiceCharacterProps) {
...
//   return (
//     <div className="CharacterChoiceList">
//       <button
//         className="showNext2"
//         onClick={() =>
//           setPage((curPage) =>
...
//         }
//       ></button>
//       <div className="addPicture2">
//         <div className="grid grid-cols-4 gap-10">
//           <label className="h-36 w-36 col-span-1" htmlFor={object.name}></label>
